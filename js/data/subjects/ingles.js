...
window.QuestionsDataSources.ingles = (function () {
  ...
  const englishT2PrepositionQuestionSpecs = [
    [
      'ING-T2-PRE-001',
      'prepositions',
      'Choose the best word: The pencil is ___ the pencil case.',
      'in',
      ['on', 'under', 'behind'],
    ...
    [
      'ING-T2-PRE-002',
      'prepositions',
      'Choose the best word: The book is ___ the table.',
      'on',
      ['in', 'under', 'between'],
    ...
    [
      'ING-T2-PRE-003',
      'prepositions',
      'Choose the best word: The shoes are ___ the bed.',
      'under',
    ...
    [
      'ING-T2-PRE-004',
      'prepositions',
      'Choose the best word: The dog is ___ the door.',
      'behind',
      ['above', 'between', 'in'],
    ...
    [
      'ING-T2-PRE-005',
      'prepositions',
      'Choose the best word: The chair is ___ the desk.',
      'next to',
      ['under', 'above', 'inside'],
    ...
    [
      'ING-T2-PRE-006',
      'prepositions',
      'Choose the best word: The ball is ___ the boxes.',
      'between',
      ['behind', 'on', 'outside'],
    ...
    [
      'ING-T2-PRE-007',
      'prepositions',
      'Choose the best word: The picture is ___ the sofa.',
      'above',
      ['under', 'in', 'near'],
    ...
    [
      'ING-T2-PRE-008',
      'prepositions',
      'Choose the best word: The school is ___ the park.',
      'near',
    ...
    [
      'ING-T2-PRE-009',
      'prepositions',
      'Which sentence means "O gato esta em cima da cadeira"?',
    ...
    [
      'ING-T2-PRE-010',
      'prepositions',
      'Which sentence means "A bola esta debaixo da mesa"?',
    ...
    [
      'ING-T2-PRE-011',
      'prepositions',
      'Which sentence means "O brinquedo esta dentro da caixa"?',
    ...
    [
      'ING-T2-PRE-012',
      'prepositions',
      'Which sentence means "A mochila esta atras da porta"?',
      ...
      [
        ...
        '"In front of" means before the door.',
    ...
    [
      'ING-T2-PRE-013',
      'prepositions',
      'Which sentence means "A menina esta na frente da escola"?',
      ...
      'The sentence uses "in front of" to show the girl is before the school.',
      [
    ...
    [
      'ING-T2-PRE-014',
      'prepositions',
      'Which sentence means "O livro esta ao lado do caderno"?',
    ...
    [
      'ING-T2-PRE-015',
      'prepositions',
      'Which sentence means "O lapis esta entre os livros"?',
    ...
    [
      'ING-T2-PRE-019',
      'prepositions',
      'Choose the sentence that uses "near" correctly.',
      ...
      [
        'If the pencil is inside the pencil case, the best word is "in".',
        'If the ball is below the table, the best word is "under".',
        'If the picture is higher than the wall area, the best word is "above".',
      ],
    ],
    [
      'ING-T2-PRE-020',
      'prepositions',
      'Choose the sentence that uses "outside" correctly.',
      'The children are outside the classroom.',
      [
        'The children are outside the box, on the table.',
        'The children are outside the chair, under it.',
        'The children are outside the pencil case, in it.',
      ],
      '"Outside" shows that the children are not inside the classroom.',
      [
        'The sentence mixes "outside" with a box and a table in an unclear way.',
        'The sentence mixes "outside" with a chair and "under".',
        'The sentence says "outside" and "in it", which gives opposite ideas.',
      ],
    ],
  ];
  ...
  const englishT2FathersDayQuestionSpecs = [
    ...
    [
      'ING-T2-FAD-003',
      'fathers_day',
      'Choose the best word: Happy ___ Day!',
      "Father's",
    ...
    [
      'ING-T2-FAD-006',
      'fathers_day',
      'Choose the best word: I made a ___ for Dad.',
      'card',
      ['shoe', 'river', 'cloud'],
    ...
    [
      ...
      ['"Desk" is furniture.', '"Apple" is fruit.', '"Chair" is furniture.'],
    ],
    [
      'ING-T2-FAD-009',
      'fathers_day',
      ...
      '"Family" means "familia".',
      ['"Escola" is "school".', '"Brinquedo" is "toy".', '"Moeda" is "coin".'],
    ],
    [
      'ING-T2-FAD-010',
      'fathers_day',
      'Which word means "abraco" in English?',
      'hug',
      ['hat', 'map', 'bag'],
      '"Hug" means "abraco".',
      ['"Hat" is "chapeu".', '"Map" is "mapa".', '"Bag" is "bolsa".'],
    ],
    [
      'ING-T2-FAD-011',
      'fathers_day',
      'Choose the best word: I give Dad a ___.',
      'hug',
      ['map', 'desk', 'fish'],
    ...
    [
      ...
      ['lapis', 'mesa', 'noite'],
      '"Love" means "amor".',
      ['"Lapis" is "pencil".', '"Mesa" is "table".', '"Noite" is "night".'],
    ],
    [
      'ING-T2-FAD-013',
      'fathers_day',
      'Which sentence means "Eu amo voce, papai"?',
      'I love you, Dad.',
      ['I see a dog.', 'I have a book.', 'I play soccer.'],
      '"I love you, Dad" means "Eu amo voce, papai".',
      [
    ...
    [
      'ING-T2-FAD-015',
      'fathers_day',
      'Choose the best word: My ___ helps me.',
      'father',
      ['ruler', 'window', 'juice'],
    ...
    [
      'ING-T2-FAD-018',
      'fathers_day',
      'Choose the best word: This ___ is for my dad.',
      'card',
      ['cloud', 'river', 'sock'],
  ...
  const englishT2SportsQuestionSpecs = [
    ...
    [
      ...
      'volei',
      ['basquete', 'natacao', 'tenis'],
      '"Volleyball" means "volei".',
      [
    ...
    [
      ...
      'natacao',
      ['corrida', 'futebol', 'skate'],
      '"Swimming" means "natacao".',
      [
        '"Corrida" is "running".',
        '"Futebol" is "soccer".',
    ...
    [
      ...
      'skate',
      ['tenis', 'corrida', 'futebol'],
      '"Skateboarding" means "skate".',
      [
        '"Tenis" is "tennis".',
        '"Corrida" is "running".',
        '"Futebol" is "soccer".',
    ...
    [
      'ING-T2-SPO-011',
      'sports',
      'Which sport uses a net and teams hit the ball with their hands?',
      'volleyball',
      ['cycling', 'running', 'skateboarding'],
      'Volleyball uses a net, and players hit the ball with their hands.',
      [
        'Cycling uses a bicycle.',
    ...
    [
      ...
      'Choose the correct sentence.',
      'I like swimming.',
      ['I like pencil.', 'I like window.', 'I like chair.'],
    ...
    [
      ...
      ['A table is furniture.', 'An apple is fruit.', 'A lamp is an object.'],
    ],
    [
      'ING-T2-SPO-019',
      'sports',
      'Which sentence means "Eu gosto de volei"?',
      'I like volleyball.',
      ['I like cycling.', 'I like tennis.', 'I like soccer.'],
      '"I like volleyball" means "Eu gosto de volei".',
      [
        '"Cycling" means "ciclismo".',
        '"Tennis" means "tenis".',
        '"Soccer" means "futebol".',
    ...
    [
      'ING-T2-SPO-020',
      'sports',
      'Which sentence means "Eu jogo tenis"?',
      'I play tennis.',
      ['I play soccer.', 'I play basketball.', 'I play volleyball.'],
      '"I play tennis" means "Eu jogo tenis".',
      [
        '"Soccer" means "futebol".',
        '"Basketball" means "basquete".',
        '"Volleyball" means "volei".',
  ...
  const englishT2ActionVerbsQuestionSpecs = [
    ...
    [
      ...
      ['"Fechar" is "close".', '"Nadar" is "swim".', '"Dancar" is "dance".'],
    ],
    [
      'ING-T2-ACT-005',
      'action_verbs',
    ...
    [
      'ING-T2-ACT-011',
      'action_verbs',
      'Choose the best verb: I ___ a book.',
      'read',
      ['drink', 'jump', 'close'],
      'We use "read" with a book.',
      [
        'We drink water or juice.',
        'We jump with the body, not a book.',
        'We can close a book, but the sentence asks the usual action with a book.',
      ],
    ],
    [
      'ING-T2-ACT-012',
